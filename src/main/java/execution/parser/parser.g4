...
sumop: PLUS | MINUS;
mulop: TIMES | DIV;
arithExpression: arithAtom | arithPM ;
...
arithPM: arithAtom sumop arithAtom;
arithAtom: variable | number ;
...
Expression: Atom | arithExpr ;
op: PLUS | MINUS;
arithExpr: Atom op Atom;
  Atom: variable | number ;

txnDeclaration
    :   KWD_TRANSACTION <Identifier> LBRACKET commands RBRACKET
    ;

    commands
    : SKIP |  variable ASSIGN Expression | commands SEMICOLON commands | commands PAR commands | txnDeclaration
